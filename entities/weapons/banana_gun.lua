...
SWEP.Author = "gm1003 ツ" -- Unfortunately
SWEP.Instructions = "Oo oo ah ah"
SWEP.Drop = false
SWEP.Spawnable = true
SWEP.AdminOnly = true
...
SWEP.ShootSound = Sound("npc/antlion_grub/squashed.wav")
...
function SWEP:PrimaryAttack()
    ...
    self:ThrowBanana("models/bioshockinfinite/hext_banana.mdl")
end
...
function SWEP:ThrowBanana(model_file)
