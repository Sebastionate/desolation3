...
do
	...
	function COMMAND:OnCheckAccess(client)
		return client:IsCombine() and (Schema:IsCombineRank(client:Name(), "SCN") or Schema:IsCombineRank(client:Name(), "RL") or Schema:IsCombineRank(client:Name(), "i1") or Schema:IsCombineRank(client:Name(), "SeC") or Schema:IsCombineRank(client:Name(), "CmD") or client:Team() == FACTION_OTA)
	end
