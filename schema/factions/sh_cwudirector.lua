...
FACTION.name = "Civil Workers Union Directors"
FACTION.description = "Directors and deputies of the Civil Workers' Union."
FACTION.color = Color(255,165,0, 255)
FACTION.pay = 25
FACTION.payTime = 2600
...
FACTION_CWUDIRECT = FACTION.index
