...
ITEM.name = "Medic Resistance Uniform"
ITEM.description = "A resistance uniform with a red medic symbol on the sleeve."
...
hook.Add("EntityTakeDamage", "ixRestistanceUniDamage", function(target, dmg)
    ...
    local uniform = inventory:HasItem("resistance_uniform_medic")
