ITEM.name = "Low Quality Cigarette Pack"
ITEM.description = "A 20-pack of some blue and nasty bootleg Universal-Union cigarettes."
...
ITEM.functions.TakeOutCigarette = {
	...
	OnRun = function(itemTable)
		...
		itemTable.player:GetCharacter():GetInventory():Add("uu_cigarette", 1)
