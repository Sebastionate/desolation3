...
Schema.voices.Add("Combine", "SHITIZEN", "Shitizen.", "shitizen.wav")
...
Schema.voices.Add("Combine", "HM", "Hmm.", "npc/metropolice/mc1ans_hm.wav")
...
Schema.voices.Add("Combine", "HOLD2", "Hold it right there!", "npc/metropolice/vo/holditrightthere.wav")
...
Schema.voices.Add("Combine", "SECTOR SECURE", "Sector is now secure.", "npc/combine_soldier/vo/sectorisnotsecure.wav")
...
Schema.voices.Add("Combine", "TAKEHIMDOWN", "Take him down!", "npc/metropolice/takedown.wav")
...
Schema.voices.Add("Combine", "CHATTER", "*Indistinct Radio Chatter*", "npc/combine_soldier/vo/prison_soldier_bunker2.wav")
Schema.voices.Add("Combine", "CHATTER2", "*Indistinct Radio Chatter*", "npc/combine_soldier/vo/prison_soldier_bunker3.wav")
Schema.voices.Add("Combine", "CHATTER3", "*Indistinct Radio Chatter*", "npc/combine_soldier/vo/prison_soldier_bunker1.wav")
Schema.voices.Add("Combine", "CHATTER4", "*Indistinct Radio Chatter*", "npc/combine_soldier/vo/prison_soldier_containd8.wav")
Schema.voices.Add("Combine", "CHATTER5", "*Indistinct Radio Chatter*", "npc/combine_soldier/vo/prison_soldier_tohighpoints.wav")
...
Schema.voices.Add("Dispatch", "ANTICITIZEN REPORTED", "Attention, ground-units: Anti-citizen reported in this community. Code: LOCK, CAUTERIZE, STABILIZE.", "npc/overwatch/cityvoice/f_anticitizenreport_spkr.wav", true)
...
Schema.voices.Add("Dispatch", "LOCAL UNREST", "Alert, community ground protection units. Local unrest structure detected. ASSEMBLE, ADMINISTER, PACIFY.", "npc/overwatch/cityvoice/f_localunrest_spkr.wav", true)
...
Schema.voices.Add("Dispatch", "EXOGEN ACTIVITY", "Alert. Nonstandard Exogen activity detected. Execute containment procedure and report.", "npc/overwatch/cityvoice/fprison_nonstandardexogen.wav", true)
Schema.voices.Add("Dispatch", "CRITICAL EXOGEN BREACH", "Overwatch acknowleges critical exogen breach. Airwatch augmentation force dispatched and inbound. Hold for reinforcement.", "npc/overwatch/cityvoice/fprison_airwatchdispatched.wav", true)
Schema.voices.Add("Dispatch", "95", "95 illegal carrying.", "npc/overwatch/radiovoice/illegalcarrying95.wav")
Schema.voices.Add("Dispatch", "603", "603 unlawful entry.", "npc/overwatch/radiovoice/unlawfulentry603.wav")
Schema.voices.Add("Dispatch", "REPORT STATUS", "Local Civil Protection team, report status.", "npc/overwatch/radiovoice/teamsreportstatus.wav")
Schema.voices.Add("Dispatch", "OFFICER CLOSING", "Officer closing on suspect.", "npc/overwatch/radiovoice/officerclosingonsuspect.wav")
Schema.voices.Add("Dispatch", "INDUSTRIAL ZONE", "Industrial zone.", "npc/overwatch/radiovoice/industrialzone.wav")
Schema.voices.Add("Dispatch", "BOL 243", "All units BOL for 243 suspect.", "npc/overwatch/radiovoice/allunitsbolfor243suspect.wav")
Schema.voices.Add("Dispatch", "NO ACTIVITY", "Airwatch copies no activity in location.", "npc/overwatch/radiovoice/airwatchcopiesnoactivity.wav")
Schema.voices.Add("Dispatch", "27", "27 attempted crime.", "npc/overwatch/radiovoice/attemptedcrime27.wav")
Schema.voices.Add("Dispatch", "PATROL", "Patrol.", "npc/overwatch/radiovoice/patrol.wav")
Schema.voices.Add("Dispatch", "CONFLICTING", "We are receiving conflicting data.", "npc/overwatch/radiovoice/recievingconflictingdata.wav")
Schema.voices.Add("Dispatch", "REPORT", "Report, please.", "npc/overwatch/radiovoice/reportplease.wav")
Schema.voices.Add("Dispatch", "243", "243 assault on protection team.", "npc/overwatch/radiovoice/assault243.wav")
Schema.voices.Add("Dispatch", "RESPOND", "Respond.", "npc/overwatch/radiovoice/respond.wav")
Schema.voices.Add("Dispatch", "94", "94 weapon", "npc/overwatch/radiovoice/weapon94.wav")
Schema.voices.Add("Dispatch", "RESTRICT", "Restrict.", "npc/overwatch/radiovoice/restrict.wav")
Schema.voices.Add("Dispatch", "UNION", "Union.", "npc/overwatch/radiovoice/union.wav")
Schema.voices.Add("Dispatch", "UPI", "UPI.", "npc/overwatch/radiovoice/upi.wav")
Schema.voices.Add("Dispatch", "SIX", "Six.", "npc/overwatch/radiovoice/six.wav")
Schema.voices.Add("Dispatch", "XRAY", "X-ray", "npc/overwatch/radiovoice/xray.wav")
Schema.voices.Add("Dispatch", "SEVEN", "Seven", "npc/overwatch/radiovoice/seven.wav")
Schema.voices.Add("Dispatch", "404 RIOT", "404 riot.", "npc/overwatch/radiovoice/riot404.wav")
Schema.voices.Add("Dispatch", "INJECT", "Inject.", "npc/overwatch/radiovoice/inject.wav")
Schema.voices.Add("Dispatch", "ONE", "One.", "npc/overwatch/radiovoice/one.wav")
Schema.voices.Add("Dispatch", "NINE", "Nine.", "npc/overwatch/radiovoice/nine.wav")
Schema.voices.Add("Dispatch", "INNOCULATE", "All local protection team units, prepare to innoculate.", "npc/overwatch/radiovoice/preparetoinnoculate.wav")
Schema.voices.Add("Dispatch", "PREMATURE MISSION", "Premature mission termination will result in.", "npc/overwatch/radiovoice/prematuremissiontermination.wav")
Schema.voices.Add("Dispatch", "OFFWORLD", "Permenant offworld service assignment.", "npc/overwatch/radiovoice/permanentoffworld.wav")
Schema.voices.Add("Dispatch", "STATUS 243", "All units report status on 243 suspect.", "npc/overwatch/radiovoice/statuson243suspect.wav")
Schema.voices.Add("Dispatch", "51B", "51-B threat to property.", "npc/overwatch/radiovoice/threattoproperty51b.wav")
Schema.voices.Add("Dispatch", "GUILTY", "You are judged guilty by Civil Protection team!", "npc/overwatch/radiovoice/youarejudgedguilty.wav")
Schema.voices.Add("Dispatch", "UNIT DOWN", "Unit down at...", "npc/overwatch/radiovoice/unitdownat.wav")
Schema.voices.Add("Dispatch", "TWO", "Two.", "npc/overwatch/radiovoice/two.wav")
Schema.voices.Add("Dispatch", "SOCIOCIDE", "Sociocide.", "npc/overwatch/radiovoice/sociocide.wav")
Schema.voices.Add("Dispatch", "THREE", "Three.", "npc/overwatch/radiovoice/three.wav")
Schema.voices.Add("Dispatch", "CONTAIN", "Remaining units contain.", "npc/overwatch/radiovoice/remainingunitscontain.wav")
Schema.voices.Add("Dispatch", "PRESSURE", "Pressure.", "npc/overwatch/radiovoice/pressure.wav")
Schema.voices.Add("Dispatch", "OUTLAND ZONE", "Outland zone.", "npc/overwatch/radiovoice/outlandzone.wav")
Schema.voices.Add("Dispatch", "ATTENTION", "Attention.", "npc/overwatch/radiovoice/attention.wav")
Schema.voices.Add("Dispatch", "647E", "647e Disengaged from work force.", "npc/overwatch/radiovoice/disengaged647e.wav")
Schema.voices.Add("Dispatch", "CHARGED WITH", "Attention, you have been charged with..", "npc/overwatch/radiovoice/attentionyouhavebeenchargedwith.wav")
Schema.voices.Add("Dispatch", "507", "507 public non-compliance.", "npc/overwatch/radiovoice/publicnoncompliance507.wav")
Schema.voices.Add("Dispatch", "NON PATROL", "Non patrol region.", "npc/overwatch/radiovoice/nonpatrolregion.wav")
Schema.voices.Add("Dispatch", "99", "99 reckless operation.", "npc/overwatch/radiovoice/recklessoperation99.wav")
Schema.voices.Add("Dispatch", "AMPUTATE", "Amputate.", "npc/overwatch/radiovoice/amputate.wav")
Schema.voices.Add("Dispatch", "AMPUTATION", "Immediate amputation.", "npc/overwatch/radiovoice/immediateamputation.wav")
Schema.voices.Add("Dispatch", "IN PROGRESS", "In progress.", "npc/overwatch/radiovoice/inprogress.wav")
Schema.voices.Add("Dispatch", "INVESTIGATE", "Investigate.", "npc/overwatch/radiovoice/investigate.wav")
Schema.voices.Add("Dispatch", "FOUR", "Four.", "npc/overwatch/radiovoice/four.wav")
Schema.voices.Add("Dispatch", "EIGHT", "Eight.", "npc/overwatch/radiovoice/eight.wav")
Schema.voices.Add("Dispatch", "FIVE", "Five", "npc/overwatch/radiovoice/five.wav")
Schema.voices.Add("Dispatch", "ZERO", "Zero.", "npc/overwatch/radiovoice/zero.wav")
Schema.voices.Add("Dispatch", "69", "69 possession of resources.", "npc/overwatch/radiovoice/posession69.wav")
Schema.voices.Add("Dispatch", "APPLY PRESSURE", "All units, apply forward pressure!", "npc/overwatch/radiovoice/allunitsapplyforwardpressure.wav")
Schema.voices.Add("Dispatch", "MISCOUNT", "Airwatch reports possible miscount.", "npc/overwatch/radiovoice/airwatchreportspossiblemiscount.wav")
Schema.voices.Add("Dispatch", "INVESTIGATE2", "Investigate and report.", "npc/overwatch/radiovoice/investigateandreport.wav")
Schema.voices.Add("Dispatch", "STERILIZATION", "All units, begin witness sterilization.", "npc/overwatch/radiovoice/allunitsbeginwhitnesssterilization.wav")
Schema.voices.Add("Dispatch", "63", "63 criminal trespass", "npc/overwatch/radiovoice/criminaltrespass63.wav")
Schema.voices.Add("Dispatch", "148", "148 resisting arrest.", "npc/overwatch/radiovoice/resistingpacification148.wav")
Schema.voices.Add("Dispatch", "MEMORY", "Reminder: memory replacement is the first step towards rank privileges.", "npc/overwatch/radiovoice/remindermemoryreplacement.wav")
Schema.voices.Add("Dispatch", "62", "62 alarms.", "npc/overwatch/radiovoice/alarms62.wav")
Schema.voices.Add("Dispatch", "VERDICT CODE", "All units: Verdict code is...", "npc/overwatch/radiovoice/allunitsverdictcodeis.wav")
Schema.voices.Add("Dispatch", "TERMINAL VERDICT", "All units, deliver terminal verdict immediately.", "npc/overwatch/radiovoice/allunitsdeliverterminalverdict.wav")
Schema.voices.Add("Dispatch", "10-0", "10-0, begin scanning.", "npc/overwatch/radiovoice/beginscanning10-0.wav")
Schema.voices.Add("Dispatch", "CITIZEN", "Citizen.", "npc/overwatch/radiovoice/citizen.wav")
Schema.voices.Add("Dispatch", "COMPLETE", "All protection team units, complete sentencing at will.", "npc/overwatch/radiovoice/completesentencingatwill.wav")
Schema.voices.Add("Dispatch", "INTERLOCK", "Interlock.", "npc/overwatch/radiovoice/interlock.wav")
Schema.voices.Add("Dispatch", "63S", "63-S illegal inoperation.", "npc/overwatch/radiovoice/illegalinoperation63s.wav")
Schema.voices.Add("Dispatch", "ISOLATE", "Isolate.", "npc/overwatch/radiovoice/isolate.wav")
Schema.voices.Add("Dispatch", "WORKFORCE", "Workforce intake hub.", "npc/overwatch/radiovoice/workforceintake.wav")
Schema.voices.Add("Dispatch", "SEARCH", "Search.", "npc/overwatch/radiovoice/search.wav")
Schema.voices.Add("Dispatch", "RESTORED", "Socio-stabilization restored.", "npc/overwatch/radiovoice/sociostabilizationrestored.wav")
Schema.voices.Add("Dispatch", "STERILIZE", "Sterilize.", "npc/overwatch/radiovoice/sterilize.wav")
Schema.voices.Add("Dispatch", "MALIGNANT", "Suspect is judged malignant. Verdict code is...", "npc/overwatch/radiovoice/suspectmalignantverdictcodeis.wav")
Schema.voices.Add("Dispatch", "RESIDENTIAL", "Residential Block.", "npc/overwatch/radiovoice/residentialblock.wav")
Schema.voices.Add("Dispatch", "PROSECUTE", "Prosecute.", "npc/overwatch/radiovoice/prosecute.wav")
Schema.voices.Add("Dispatch", "CAUTERIZE", "Cauterize.", "npc/overwatch/radiovoice/cauterize.wav")
Schema.voices.Add("Dispatch", "IS NOW", "Is now...", "npc/overwatch/radiovoice/isnow.wav")
Schema.voices.Add("Dispatch", "LEVEL 5", "Level five anti-civil activity.", "npc/overwatch/radiovoice/level5anticivilactivity.wav")
Schema.voices.Add("Dispatch", "LOCK", "Lock.", "npc/overwatch/radiovoice/lock.wav")
Schema.voices.Add("Dispatch", "CODE 3", "Reinforcement teams, code 3.", "npc/overwatch/radiovoice/reinforcementteamscode3.wav")
Schema.voices.Add("Dispatch", "FRACTURE", "Social fracture in progress. Respond.", "npc/overwatch/radiovoice/socialfractureinprogress.wav")
Schema.voices.Add("Dispatch", "COMMUNAL UNREST", "Promoting communual unrest.", "npc/overwatch/radiovoice/promotingcommunalunrest.wav")
Schema.voices.Add("Dispatch", "NEGOTIATION", "Suspend negotiations.", "npc/overwatch/radiovoice/suspendnegotiations.wav")
Schema.voices.Add("Dispatch", "10-103m", "10-103m disturbance by mentally unfit.", "npc/overwatch/radiovoice/disturbancemental10-103m.wav")
Schema.voices.Add("Dispatch", "DISSOCIATION", "Dissociation from the civic populace.", "npc/overwatch/radiovoice/disassociationfromcivic.wav")
Schema.voices.Add("Dispatch", "ANTICITIZEN1", "Attention. Prepare visual download on Anti-Citizen 1.", "npc/overwatch/radiovoice/preparevisualdownload.wav")
Schema.voices.Add("Dispatch", "404 ZONE", "404 zone.", "npc/overwatch/radiovoice/404zone.wav")
Schema.voices.Add("Dispatch", "ACCOMPLICES", "Protection teams, be advised accomplices operating in area.", "npc/overwatch/radiovoice/accomplicesoperating.wav")
Schema.voices.Add("Dispatch", "ADMINISTER", "Administer.", "npc/overwatch/radiovoice/administer.wav")
Schema.voices.Add("Dispatch", "TEAMS RESPOND", "All teams respond, code 3.", "npc/overwatch/radiovoice/allteamsrespondcode3.wav")
Schema.voices.Add("Dispatch", "CAPITAL MALCOMPLIANCE", "Capital Malcompliance.", "npc/overwatch/radiovoice/capitalmalcompliance.wav")
Schema.voices.Add("Dispatch", "CONTROL SECTION", "Polity: Control Section.", "npc/overwatch/radiovoice/controlsection.wav")
Schema.voices.Add("Dispatch", "DESTRUCTION", "Destruction of corporal Social Protection units.", "npc/overwatch/radiovoice/destrutionofcpt.wav")
Schema.voices.Add("Dispatch", "DIVISIVE", "Divisive sociocidal counter-obeyance.", "npc/overwatch/radiovoice/devisivesociocidal.wav")
Schema.voices.Add("Dispatch", "DISASSOCIATION", "Disassociation from the civic populace.", "npc/overwatch/radiovoice/disassociationfromcivic.wav")
Schema.voices.Add("Dispatch", "415", "415 civic disunity.", "npc/overwatch/radiovoice/disturbingunity415.wav")
Schema.voices.Add("Dispatch", "ENGAGING TEAM", "Engaging Protection Team is non-cohesive.", "npc/overwatch/radiovoice/engagingteamisnoncohesive.wav")
Schema.voices.Add("Dispatch", "EXAMINE", "Examine.", "npc/overwatch/radiovoice/examine.wav")
Schema.voices.Add("Dispatch", "EXTERNAL", "External jurisdiction.", "npc/overwatch/radiovoice/externaljurisdiction.wav")
Schema.voices.Add("Dispatch", "FAILURE TO COMPLY", "Failure to comply with the civil will.", "npc/overwatch/radiovoice/failuretocomply.wav")
Schema.voices.Add("Dispatch", "OUTBREAK", "Stabilization Team: failure to treat identified local outbreak will force team recall and recycle.", "npc/overwatch/radiovoice/failuretotreatoutbreak.wav")
Schema.voices.Add("Dispatch", "FINAL VERDICT", "Final verdict administered.", "npc/overwatch/radiovoice/finalverdictadministered.wav")
Schema.voices.Add("Dispatch", "17F", "17-F fugitive detachment", "npc/overwatch/radiovoice/fugitive17f.wav")
Schema.voices.Add("Dispatch", "REPORT DESERVICED", "Attention Stabilization Team leader. Report de-serviced unit to sterilized body count ratio for reinforcement, reward, or removal processing.", "npc/overwatch/radiovoice/leadersreportratios.wav")
Schema.voices.Add("Dispatch", "LOCKDOWN", "Protection Team: lock down your location: sacrifice code.", "npc/overwatch/radiovoice/.wav")
Schema.voices.Add("Dispatch", "NONCITIZEN", "non-citizen.", "npc/overwatch/radiovoice/noncitizen.wav")
Schema.voices.Add("Dispatch", "51", "51 non-sanctioned arson", "npc/overwatch/radiovoice/nonsanctionedarson51.wav")
Schema.voices.Add("Dispatch", "PERMANENT OFFWORLD", "Permanent off-world service assignment.", "npc/overwatch/radiovoice/permanentoffworld.wav")
Schema.voices.Add("Dispatch", "POLISTABILIZATION", "Notice: Protection Teams: civic politistabilization index is marginal.", "npc/overwatch/radiovoice/politistablizationmarginal.wav")
Schema.voices.Add("Dispatch", "FINAL SENTENCING", "Prepare for final sentencing.", "npc/overwatch/radiovoice/prepareforfinalsentencing.wav")
Schema.voices.Add("Dispatch", "PREPARE VERDICT", "Prepare to receive verdict.", "npc/overwatch/radiovoice/preparetoreceiveverdict.wav")
Schema.voices.Add("Dispatch", "PRESERVE", "Preserve.", "npc/overwatch/radiovoice/preserve.wav")
Schema.voices.Add("Dispatch", "PRODUCTION BLOCK", "Production block.", "npc/overwatch/radiovoice/productionblock.wav")
Schema.voices.Add("Dispatch", "QUICK", "Quick.", "npc/overwatch/radiovoice/quick.wav")
Schema.voices.Add("Dispatch", "RECALIBRATE", "Team: recalibrate socioscan.", "npc/overwatch/radiovoice/recalibratesocioscan.wav")
Schema.voices.Add("Dispatch", "REPRODUCTION", "Rank leader: reminder: 100 sterilized credits qualifies non-mechanical reproduction simulation.", "npc/overwatch/radiovoice/reminder100credits.wav")
Schema.voices.Add("Dispatch", "REPURPOSED", "Repurposed area.", "npc/overwatch/radiovoice/repurposedarea.wav")
Schema.voices.Add("Dispatch", "RESTRICTED BLOCK", "Restricted block.", "npc/overwatch/radiovoice/restrictedblock.wav")
Schema.voices.Add("Dispatch", "INCURSION", "Restricted incursion in progress.", "npc/overwatch/radiovoice/restrictedincursioninprogress.wav")
Schema.voices.Add("Dispatch", "REWARD NOTICE", "Reward notice: Protection Team member: your family cohesion is preserved.", "npc/overwatch/radiovoice/rewardnotice.wav")
Schema.voices.Add("Dispatch", "ROLLER", "Roller.", "npc/overwatch/radiovoice/roller.wav")
Schema.voices.Add("Dispatch", "SECTOR", "Sector.", "npc/overwatch/radiovoice/sector.wav")
Schema.voices.Add("Dispatch", "SERVE", "Serve.", "npc/overwatch/radiovoice/serve.wav")
Schema.voices.Add("Dispatch", "STABILIZATION", "Stabilization jurisdiction.", "npc/overwatch/radiovoice/stabilizationjurisdiction.wav")
Schema.voices.Add("Dispatch", "STATION BLOCK", "Station block.", "npc/overwatch/radiovoice/stationblock.wav")
Schema.voices.Add("Dispatch", "STICK", "Stick.", "npc/overwatch/radiovoice/stick.wav")
Schema.voices.Add("Dispatch", "STORM SYSTEM", "Storm system.", "npc/overwatch/radiovoice/stormsystem.wav")
Schema.voices.Add("Dispatch", "SUBJECT", "Subject.", "npc/overwatch/radiovoice/subject.wav")
Schema.voices.Add("Dispatch", "SUSPEND", "Suspend.", "npc/overwatch/radiovoice/suspend.wav")
Schema.voices.Add("Dispatch", "TAP", "Tap.", "npc/overwatch/radiovoice/tap.wav")
Schema.voices.Add("Dispatch", "TERMINAL", "Terminal prosecution.", "npc/overwatch/radiovoice/terminalprosecution.wav")
Schema.voices.Add("Dispatch", "TERMINAL ZONE", "Terminal restriction zone.", "npc/overwatch/radiovoice/terminalrestrictionzone.wav")
Schema.voices.Add("Dispatch", "TRANSIT BLOCK", "Transit block.", "npc/overwatch/radiovoice/transitblock.wav")
Schema.voices.Add("Dispatch", "DESERVICED", "Unit deserviced.", "npc/overwatch/radiovoice/unitdeserviced.wav")
Schema.voices.Add("Dispatch", "VICE", "Vice.", "npc/overwatch/radiovoice/vice.wav")
Schema.voices.Add("Dispatch", "VICTOR", "Victor.", "npc/overwatch/radiovoice/victor.wav")
Schema.voices.Add("Dispatch", "CIVIC TRUST", "Violation of civic trust.", "npc/overwatch/radiovoice/violationofcivictrust.wav")
Schema.voices.Add("Dispatch", "WASTE RIVER", "Waste river.", "npc/overwatch/radiovoice/wasteriver.wav")
Schema.voices.Add("Dispatch", "YELLOW", "Yellow.", "npc/overwatch/radiovoice/yellow.wav")
Schema.voices.Add("Dispatch", "ZONE", "Zone.", "npc/overwatch/radiovoice/zone.wav")
Schema.voices.Add("Dispatch", "CODE 12", "All units return to code 12.", "npc/overwatch/radiovoice/allunitsreturntocode12.wav")
Schema.voices.Add("Dispatch", "ANTICITIZEN", "Anti-citizen", "npc/overwatch/radiovoice/anticitizen.wav")
Schema.voices.Add("Dispatch", "ANTIFATIGUE", "Anti-fatigue ration is now 3 milligrams.", "npc/overwatch/radiovoice/antifatigueration3mg.wav")
Schema.voices.Add("Dispatch", "APPLY", "Apply.", "npc/overwatch/radiovoice/apply.wav")
Schema.voices.Add("Dispatch", "BLOCK", "Block.", "npc/overwatch/radiovoice/block.wav")
Schema.voices.Add("Dispatch", "CANAL BLOCK", "Canal block.", "npc/overwatch/radiovoice/canalblock.wav")
Schema.voices.Add("Dispatch", "CONDEMNED ZONE", "Condemned zone.", "npc/overwatch/radiovoice/condemnedzone.wav")
Schema.voices.Add("Dispatch", "CONFIRM UPI", "Team: confirm UPI alert.", "npc/overwatch/radiovoice/confirmupialert.wav")
Schema.voices.Add("Dispatch", "DEFENDER", "Defender.", "npc/overwatch/radiovoice/defender.wav")
Schema.voices.Add("Dispatch", "DISTRIBUTION BLOCK", "Distribution block.", "npc/overwatch/radiovoice/distributionblock.wav")
Schema.voices.Add("Dispatch", "DOCUMENT", "Document.", "npc/overwatch/radiovoice/document.wav")
Schema.voices.Add("Dispatch", "SKYSHIELD", "Sky-shield.", "npc/overwatch/radiovoice/fmil_region_073.wav")
Schema.voices.Add("Dispatch", "HIGH PRIORITY REGION", "High priority region.", "npc/overwatch/radiovoice/highpriorityregion.wav")
Schema.voices.Add("Dispatch", "INFECTION", "Infection.", "npc/overwatch/radiovoice/infection.wav")
Schema.voices.Add("Dispatch", "INFESTED ZONE", "Infested Zone.", "npc/overwatch/radiovoice/infestedzone.wav")
Schema.voices.Add("Dispatch", "INOCULATE", "Inoculate.", "npc/overwatch/radiovoice/inoculate.wav")
Schema.voices.Add("Dispatch", "INTERCEDE", "Intercede.", "npc/overwatch/radiovoice/intercede.wav")
Schema.voices.Add("Dispatch", "JURY", "Jury.", "npc/overwatch/radiovoice/jury.wav")
Schema.voices.Add("Dispatch", "KING", "King.", "npc/overwatch/radiovoice/king.wav")
Schema.voices.Add("Dispatch", "LINE", "Line.", "npc/overwatch/radiovoice/line.wav")
Schema.voices.Add("Dispatch", "OFFICER", "Officer.", "npc/overwatch/radiovoice/officerat.wav")
Schema.voices.Add("Dispatch", "PREPARE INOCULATE", "All local Protection Team units: prepare to inoculate.", "npc/overwatch/radiovoice/preparetoinnoculate.wav")
Schema.voices.Add("Dispatch", "VISUAL DOWNLOAD", "Attention: prepare visual download.", "preparevisualdownloadnew.wav")


Schema.voices.Add("Vortigaunt", "ALERT", "Alert!", "vo/npc/vortigaunt/alert.wav")
Schema.voices.Add("Vortigaunt", "DONE", "Done.", "vo/npc/vortigaunt/alert.wav")
...
Schema.voices.Add("Vortigaunt", "VORTGROWL", "*Indistinct Vortigese*", "vo/npc/vortigaunt/vortigese02.wav")
Schema.voices.Add("Vortigaunt", "VORTCHANT", "*Indistinct Vortigese*", "vo/npc/vortigaunt/vortigese11.wav")
Schema.voices.Add("Vortigaunt", "VORTCHANT2", "*Indistinct Vortigese*", "vo/npc/vortigaunt/vortigese12.wav")
Schema.voices.Add("Vortigaunt", "VORTCHANT3", "*Indistinct Vortigese*", "vo/npc/vortigaunt/vortigese13.wav")
...
Schema.voices.AddClass("Combine", function(client)
	return client:IsCombine() and client:Team() != FACTION_DISPATCH
end)


Schema.voices.AddClass("Dispatch", function(client)
	return client:Team() == FACTION_DISPATCH
end)

Schema.voices.AddClass("Vortigaunt", function(client)
	return client:Team() == FACTION_VORT or client:Team() == FACTION_FREEVORT
end)
